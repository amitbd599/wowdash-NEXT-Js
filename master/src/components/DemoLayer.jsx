        ...
        {loading && (
          <div className='preloader'>
            ...
            <div>
                {/* Mobile Menu */}
                <div
                    className={`mobile-menu scroll-sm d-lg-none d-block ${isMobileMenuActive ? "active" : ""
                        }`}
                >
                    <button
                        type='button'
            ...
            <div className='overflow-hidden'>
                ...
                <section className='demo-section py-120 bg-img' id='demos'>
                    <div className='container'>
                        <div className='section-heading'>
                            <h1 className='section-heading__title'>20+</h1>
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img12.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img13.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img14.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img15.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img16.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img17.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img18.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img19.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                                    ...
                                    >
                                        <div className='demo-item upcoming-item position-relative'>
                                            <div className='demo-item__inner bg-light-gradient-1'>
                                                <div className='demo-item__thumbs position-relative'>
                                                    <img
                                                        src='assets_demo/images/thumbs/demo-img20.png'
                                                        alt=''
                                                    />
                                                    <div className='demo-item__overlay'>
                                                        <Link
                ...
                >
                    <div className='container'>
                        <div className='section-heading'>
                            <h1 className='section-heading__title'>10+</h1>
